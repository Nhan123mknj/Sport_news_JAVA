...
<section class="blog-hero-section set-bg" data-setbg="${articles.image}">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="bh-text">
					...
					<ul>
						...
						<li><i class="fa fa-calendar"></i> ${articles.created_at}</li>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 left-blog-pad">
				<div class="bd-text">
					<div class="bd-title">
						<p>Argentina had defended stoutly, as they had against Japan
							in their opening game, but England finally produced a chance they
							could not miss in the 61st minute when a counter found Beth Mead
							on the left, and her excellent low cross beat both centre-backs
							allowing Taylor forward to tap in.</p>
						<p>Jill Scott should have doubled the lead soon after but
							headed Alex Greenwood's delivery over, before England saw the
							match out with relative ease to leave them needing just a point
							in their final game with Japan, next Wednesday, to top Group D.</p>
						<p>Straight from kick off, England looked to dominate against
							a defensive Argentina side, but while their build-up was much
							improved from their shaky win over Scotland last Sunday, their
							final ball was still lacking.</p>
					</div>
					<div class="bd-pic">
						<div class="row">
							<div class="col-md-4">
					...
					<div class="bd-tags">
						<a href="#">Multipopuse</a> <a href="#">Design</a> <a href="#">Ideas</a>
					</div>
					<div class="comment-option">
						...
						<div class="single-comment-item first-comment">
							...
							<div class="sc-text">
								...
								<p>Vasse Felix chief executive, Paul Holmes a Court said no
									plans have yet been made for the buildings on the property.</p>
								<a href="#" class="comment-btn like-btn">Like</a> <a href="#"
			...
			<div class="col-lg-4">
				<div class="blog-sidebar">
					...
					<div class="bs-popular-tag">
						...
						<div class="tags">
							<a href="#">Seagame</a> <a href="#">Fifa</a> <a href="#">World
								Cup 2019</a> <a href="#">Championship</a> <a href="#">2019</a> <a
								href="#">Qatar</a>
						</div>
					</div>
				</div>
