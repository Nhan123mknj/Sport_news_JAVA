...
<link rel="icon" type="image/x-icon"
	href="assets/admin/img/favicon/favicon.ico" />
...
<!-- Core CSS -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/admin/vendor/css/core.css"
class="template-customizer-core-css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/admin/vendor/css/theme-default.css"
	class="template-customizer-theme-css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/admin/css/demo.css" />

<!-- Vendors CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/admin/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />

<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/admin/vendor/libs/apex-charts/apex-charts.css" />

<!-- Page CSS -->

<!-- Helpers -->
<script src="${pageContext.request.contextPath}/assets/admin/vendor/js/helpers.js"></script>


<script src="${pageContext.request.contextPath}/assets/admin/js/config.js"></script>
</head>
		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<ul class="menu-inner py-1">
					<c:forEach var="entry" items="${menuTree}">
						<!-- Menu Cha -->
						<li
							class="menu-item <c:if test="${entry.value != null && not empty entry.value}">menu-toggle</c:if>">
							<a href="javascript:void(0);" class="menu-link"> <i
								class="menu-icon tf-icons bx bx-home-circle"></i>
								<div data-i18n="${entry.key.menu_name}">${entry.key.menu_name}</div>
						</a> <!-- Menu Con --> <c:if test="${not empty entry.value}">
								<ul class="menu-sub">
									<c:forEach var="subMenu" items="${entry.value}">
										<li class="menu-item"><a href="${subMenu.link}"
											class="menu-link">
							...
							<li class="nav-item navbar-dropdown dropdown-user dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end">
									...
									<li><a class="dropdown-item" href="logout"> <i
											class="bx bx-power-off me-2"></i> <span class="align-middle">Đăng
												xuất</span>
									</a></li>
								</ul>
							</li>
